...
typedef enum { DirectionalEmitter, RadialEmitter, SphereEmitter, ConeEmitter } EmitterType;
...
public:
	...
	void setEmitterPosition(const ofVec3f & p) { setPosition(p); }
	ParticleSystem *sys;
	float rate;         // per sec
	bool oneShot;
	bool fired;
